...
def create_all_for_testing() -> None:
    from web.backend import analysis_limits, asset_entries, audit, data_sources, job_records, llm_models, report_metadata, screener_runs, search_quota, trade_entries  # noqa: F401
