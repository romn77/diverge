...
Output conversationally, then use the following structure for the `highlights` field in your structured response:
...
{structured_agent_output_instruction()}"""
    ...
    def apply_response(self, state, spec, response) -> dict:
        ...
        new_risk_debate_state = {
            ...
            "current_aggressive_response": spec.metadata["current_aggressive_response"],
